...
<div style="width:245px; height:430px; margin:0 auto;">
	...
	<div style="background:#F55641; height:65px; width:95%; margin: 5px auto; margin-bottom:0px; -moz-border-radius-topleft: 10px;-moz-border-radius-topright: 10px;-webkit-border-top-left-radius: 10px;-webkit-border-top-right-radius: 10px;">
		<div style="line-height:65px; text-align:center; font-family: '微软雅黑 Regular', '微软雅黑'; font-weight: 400; color: #F9E152;font-size: 20px;" id="businessName"><span style="color:#FFFFFF;">欢迎进入</span><a href="${redPackageContentData.packageForPageUrl}" style="text-decoration: none;color: #F9E152;">${redPackageContentData.businessName}</a></div>
	</div>
...
<div class="u4">
	<div class="u5"><img src="${root}/images/redEnvelopes/u144.png" /><label id="businessName">${redPackageContentData.businessName}</label></div>
	<div class="u11">
	加油，红包马上就完成了！
	</div>
	<a href="${redPackageContentData.packageForPageUrl}" style="text-decoration: none;"><div class="u8">去小店微站逛逛</div></a>
</div>
</body>
</html>
