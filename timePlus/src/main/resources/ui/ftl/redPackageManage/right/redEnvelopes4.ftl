...
<div id="redPackAgeMaskRule">
	...
	<div class="redPackAgeRuleBg">
		...
		<div id="packageRule" class="redPackAgeRuleContent">
			${(redPackageContentData.packageRule)?default("")}
		</div>
	</div>
</div>
...
-webkit-border-bottom-right-radius: 10px;color: #333333;font-weight: 600;font-size: 14px;text-align: center;white-space:nowrap; line-height:40px;">活动规则</div>
	</div>
</div>
</body>
</html>
